        ...
        akka {
            ...
            actor {
                ...
                serializers {
                    ...
                    plainnewtonsoft = "Actor+PlainNewtonsoftJsonSerializer, TensaiMakoto"
                }
                serialization-bindings {
                    "System.Object" = json
                    "Common+IDefaultTag, TensaiMakoto" = plainnewtonsoft
                }
            }
            remote {
                helios.tcp {
            ...
            persistence{
                ...
                journal {
                  ...
                  sqlite
                  {
                      connection-string = "Data Source=TensaiMakoto.db;"
                      auto-initialize = on
                      event-adapters.tagger = "Actor+Tagger, TensaiMakoto"
                      event-adapter-bindings {
                        "Common+IDefaultTag, TensaiMakoto" = tagger
                      }
...
[<Literal>]
let resolutionPath = __SOURCE_DIRECTORY__ + @"\..\TensaiMakoto.Web\net46"

[<Literal>]
let connectionString =
    @"Data Source=" + __SOURCE_DIRECTORY__ + @"\..\TensaiMakoto.Web\TensaiMakoto.db;"
